...
;(function(window) {
	...
	GridFx.prototype.options = {
		...
		//If negative then it means the alignment is left 
		//and/or top rather than right and/or bottom
		// so, as an example, if we want our large image to be 
		//positioned vertically on 25% of the screen and centered horizontally the values would be x:1,y:-0.25
		imgPosition : { x : 1, y : 1 },
